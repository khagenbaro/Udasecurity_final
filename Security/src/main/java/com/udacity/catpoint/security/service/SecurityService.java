...
public class SecurityService {
    ...
    public void setArmingStatus(ArmingStatus armingStatus) {
        ...
        if (armingStatus == ArmingStatus.DISARMED) {
            ...
            ConcurrentSkipListSet<Sensor> allSensors = new ConcurrentSkipListSet<>(getSensors());
...
//    helper function for test coverage which changes alarm status to pending
    public void changeSenorActivation(){
